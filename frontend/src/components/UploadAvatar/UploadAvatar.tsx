...
export function UploadAvatar({profilePicPath, onClick} : any) {
  return (
    <>
    {profilePicPath == "" ? (
          <div onClick={onClick} className='app-upload-avatar shrink-0'>
            <div>
                  <svg
                  width='18'
                  height='18'
    ...
    : (
      <div onClick={onClick} className="app-upload-avatar shrink-0">
        <img className='h-25 w-25 shrink-0' style={{borderRadius: "50%"}} src={profilePicPath} />
